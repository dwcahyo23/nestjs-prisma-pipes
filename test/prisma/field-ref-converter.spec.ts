// import { convertFieldReferences, createFieldRefConverter } from "../../src/helpers/field-ref-converter.helper";
...
// 			const result = convertFieldReferences(input, mockModelDelegate);
...
// 			expect(convertFieldReferences(null, mockModelDelegate)).toBeNull();
// 			expect(convertFieldReferences(undefined, mockModelDelegate)).toBeUndefined();
// 		});

// 		it('should handle primitives', () => {
// 			expect(convertFieldReferences('string', mockModelDelegate)).toBe('string');
// 			expect(convertFieldReferences(123, mockModelDelegate)).toBe(123);
// 			expect(convertFieldReferences(true, mockModelDelegate)).toBe(true);
// 		});
...
// 			// Nested paths are kept as-is since Prisma doesn't support cross-table field refs directly
// 			expect(result).toEqual({
// 				balance: {
// 					gte: { _ref: 'user.minBalance', _isFieldRef: true },
// 				},
...
// 			// Unknown fields are kept as-is, Prisma will throw appropriate error
// 			expect(result).toEqual({
// 				qty: {
// 					lte: { _ref: 'unknownField', _isFieldRef: true },
// 				},
...
// 			const converter = createFieldRefConverter(mockModelDelegate);
